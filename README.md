...
This repository contains the code for the paper [On the design of convolutional neural networks for automatic detection of Alzheimer’s disease](https://arxiv.org/pdf/1911.03740.pdf). Author: ELjan Guluyev, Nijat Mukhtarov, Rashad Rajabli, Sheng Liu, Chhavi Yadav, Carlos Fernandez-Granda, Narges Razavian.
...
## Download ADNI data
1. Request approval and register at [ADNI website (currently out of service)](http://adni.loni.usc.edu/data-samples/access-data/)
...
## References
- Sheng Liu, Chhavi Yadav, Carlos Fernandez-Granda, Narges Razavian, Eljan Guluyev. "On the design of convolutional neural networks for automatic detection of Alzheimer’s disease", in NeurIPS ML4H, 2019.
